...
export default function SavedPapersPage() {
  ...
  if (loading) return <AcademyLayout><div className="text-center py-5"><div className="spinner-border text-primary" /></div></AcademyLayout>;
        ...
        <div className="container-fluid">
          <div className="row align-items-center mb-2 g-3">
            <div className="col-md">
              ...
              <p className="text-muted text-center">Manage your premium papers.</p>
            </div>
